package com.hogar360.houses.houses.infrastructure.security.config;

import com.hogar360.houses.houses.infrastructure.security.filters.JwtAuthenticationFilter;
import com.hogar360.houses.houses.infrastructure.security.utils.JwtUtil;
import com.hogar360.houses.houses.infrastructure.security.utils.SecurityConstants;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(SecurityConstants.HOUSE_PROTECTED_PATH_LIST_ALL).authenticated()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        corsConfiguration.setAllowedOrigins(List.of(SecurityConstants.ALLOWED_ORIGIN));
